...
public class DateUtil {
	...
	public static final String TIMESTAMP_PATTERN = DATE_PATTERN + " "
			+ TIME_PATTERN;
	...
	/**
	 * 传年份和月份2015和月份5获取2015-05-01的Date
	 */
	public static Date getyear(int year,int month){
		...
		sb.append("-01");
		return convertStringToDate(sb.toString(),DATE_PATTERN);
	}
	...
	public static String getSevenDays(){
	    ...
	    for (int i = 6; i >= 0; i--){
	    	...
	    	day = c.getTime();
	    	if (i == 0){
	    		days.append(convertDateToString(day, DATE_PATTERN));
	    	}else{
	    		days.append(convertDateToString(day, DATE_PATTERN)+",");
	    	}    	
	    }
