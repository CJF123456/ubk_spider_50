...
/**
 *  2017-04-18 第四季度数据采集完毕
 * @author Administrator
 *
 */
public class StatsFsjdSpider extends BaseSpider {

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(StatsFsjdSpider.class
	...
	public static void main(String[] args) {
		update = true;
		tablePre = "fsjd";
		tableTreeName = "region_datafield_quarter";
		tableDataName = "region_quarter_data";
		frequency = 2;
		new StatsFsjdSpider().getQuotasTree();
	}
