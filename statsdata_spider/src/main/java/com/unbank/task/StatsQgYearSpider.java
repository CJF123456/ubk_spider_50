...
//
//@Component
//public class StatsQgYearSpider {
//
...
//		dataindex.put(4, "");
//		dataindex.put(6, "");
//		new StatsQgYearSpider().getQuotasTree();
//	}
//	
//	
//	
...
//					urlde = url + "?m=QueryData&code=" + id + "&wds=%5B%5D";
//					clikeTime(id, codetime, urlde);
//				} else {
//					try {
//						Thread.sleep(100);
...
//						codetime = o1.get("code").toString();
//
//						if (codetime.equals("000000")) {
//							urlde = url
//									+ "?m=QueryData&code="
//									+ id
//									+ "&wds=%5B%7B%22wdcode%22%3A%22reg%22%2C%22valuecode%22%3A%22000000%22%7D%5D";
//
//						} else {
//							urlde = url
//									+ "?m=QueryData&code="
//									+ id
//									+ "&wds=%5B%7B%22wdcode%22%3A%22sj%22%2C%22valuecode%22%3A%22"
//									+ codetime + "%22%7D%5D";
//
//						}
//						clikeTime(id, codetime, urlde);
...
//		}
//		}
//	private void clikeTime(String id, String codetime, String urlde) {
//			Map<String, String> params = new HashMap<String, String>();
//			 String  html1= fetcher.post(urlde, params, headers, charset);
...
//					codetime = null;
//				}
//				String html = html1.toString().split("htmltable")[1].substring(3)
//						.split("memos")[0];
//				String text = html.substring(0, html.length() - 3);
//				String detail = id + codetime;
//				String quotasidDetail = md.GetMD5Code(detail);
//		   if (urlFilter.checkNewsURL(quotasidDetail)) {
//				try {
//					QgydData newHgyd =new QgydData();
//					newHgyd.setText(text);
//					newHgyd.setTime(codetime);
//					newHgyd.setHgyddeatail(quotasidDetail);
