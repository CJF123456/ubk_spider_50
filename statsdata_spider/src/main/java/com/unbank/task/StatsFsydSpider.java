 ...
 * 
 */
public class StatsFsydSpider extends BaseSpider {

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(StatsFsydSpider.class
	...
	public static void main(String[] args) {
		update = true;
		tablePre = "fsyd";
		tableTreeName = "region_datafield_month";
		tableDataName = "region_month_data";
		frequency = 3;
		new StatsFsydSpider().getQuotasTree();
	}
