...
public class ReaderLine {
	...
	/**
	 * @description: 将文件内容按行读取存放到List里面 @param: @param fileName @return:
	 * void @throws
	 */
	...
	/**
	 * @description: 获取随机行数的字符串 @param: @return @return: String @throws
	 */
	...
	public String ReaderUserByFile() {
		...
		try {
			path = ReaderLine.class.getClassLoader().getResource("").toURI().getPath();
