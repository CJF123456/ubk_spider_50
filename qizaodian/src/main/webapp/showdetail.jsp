				...
				<div class="col-sm-12">
					...
					<div class="collapse navbar-collapse" id="main-menu">
						<ul class="menu">
							...
							<li><a href="/qizaodian/readerPoetrys.do"target="_blank">书摘社区</a></li>
						</ul>
					...
					<article class="post">
						<header class="post-head">
							...
							<section class="post-meta">
								...
								<time class="post-date" title="${pubdate}"><fmt:formatDate value="${pubdate}" pattern="yyyy-MM-dd" type="date" />
								</time>
							</section>
						</header>
