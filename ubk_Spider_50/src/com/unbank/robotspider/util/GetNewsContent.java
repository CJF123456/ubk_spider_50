...
public class GetNewsContent {
	...
	/*
	 * // 通用得到新闻内容（比较节点最大的内容节点） public static String getNewsContent(String url,
	 * Document document, String title) { if (document == null) {
	 * logger.info("url错误" + url); return null; } Filter filter =
	 * FilterLocator.getInstance().getFilter(url); String content=
	 * filter.getContent(url, document, title); return content; }
	 */
}
