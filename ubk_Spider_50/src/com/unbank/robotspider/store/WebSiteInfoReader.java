...
public class WebSiteInfoReader {
	...
	private WebSiteInfoExample getTask1ConditionExample(Integer task) {
		WebSiteInfoExample webSiteInfoExample = new WebSiteInfoExample();
		// Date strartTime = getMyDate(new Date(), -7);
		webSiteInfoExample.or().andIstaskEqualTo(task).andWebsiteIdEqualTo(18077);
				//.andWebsiteIdGreaterThanOrEqualTo(Values.v.WEBSITEID);
		
		webSiteInfoExample.setOrderByClause("website_id desc ");
