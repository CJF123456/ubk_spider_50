...
public class ContentTest {
	...
	public static void main(String[] args) throws IOException {
		...
		// //
		String url = "http://finance.nen.com.cn/system/2017/05/24/019877044.shtml";
		Document document = new JsoupNetFetcher().fetchText(url);
		//System.out.println(document);
//		div.c-b:nth-child(3) > div:nth-child(1) > strong:nth-child(1) > a:nth-child(1)
		Elements element = document
				.select("div.content > div.clearfix.w1000_320.path > div.clearfix.w1000_320.text_title.fl > h1");
		System.out.println(element);
	  //system.out.println（“hello my world”）
		//System.out.println("hello my word");
		// // // System.out.println(document);
		// String title = document.title();
		// title = new TitlePaser().getTitle(document, title);
		// System.out.println(title);
		// String content = new ContentPaser().extractNewsContent(url, document,
		// title);
		...
		// String a =
		// URLEncoder.encode("{cea6b3de-e94b-4176-b806-1034ecf811e8}",
		// "utf-8");
		// String b =
		// URLDecoder.decode("%7B716f4031-c9e3-4824-8279-60018cd5a85a%7D.xml",
		// "utf-8");
